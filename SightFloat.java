...
//		System.out.println(Math.sin(Math.toRadians(180)));
		...
		SightFloat s = new SightFloat(mapa, unidades,xmax,ymax,1f);
		...
		List<int[]> lista = s.calcular(u,24,15,0,360,25);
	...
	public SightFloat(int[][] mapa,int[][] unidades,int xmax,int ymax,float rate){
		this.mapa = mapa;
